...
## Versión actual: v1.8.1 | Bloqueador Cosmético v1.8.0 + Motor IA Nativo In-Process 100% Autónomo v1.8.1
...
| Fase 6 — Sesiones y Login | COMPLETA v1.4.3 (Mounted checks, AuthService y cookies) |
...
| Fase 9 — Perfiles HW & GGUF IA | COMPLETA v1.8.1 (Detección HW, Descargas HuggingFace, Importador Ollama, Inactividad RAM) |
...
*Generado por ANTIGRAVITY | DulceNav v1.8.1 | Sesión 46c3197e | 2026-07-26*
