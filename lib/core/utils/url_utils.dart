...
class UrlUtils {
  ...
  static String processInput(String input, {String? searchEngine}) {
    ...
    // Paginas internas (incluye alias de Chromium / WebView2 / Android)
    if (trimmed.startsWith('about:dulcenav')) return 'about:dulcenav';
    if (trimmed.startsWith('about:')) return trimmed;
    if (trimmed.startsWith('chrome://dulcenav')) return 'about:dulcenav';
    if (trimmed.startsWith('chrome://')) return 'about:dulcenav';
  ...
  // -- Es pagina de inicio (incluye alias de Chromium / WebView2) --
  static bool isHomePage(String url) =>
      url == 'about:dulcenav' ||
      url.startsWith('about:dulcenav') ||
      url == 'about:blank' ||
      url.isEmpty ||
      url.startsWith('edge://dulcenav') ||
      url.startsWith('edge://new-tab') ||
      url.startsWith('chrome://dulcenav') ||
