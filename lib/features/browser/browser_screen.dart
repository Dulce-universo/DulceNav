...
class _BrowserScreenState extends State<BrowserScreen>
  ...
  void _doNavigate(String url) {
    ...
    _webViewController.resetForNewTab(url);

    if (UrlUtils.isHomePage(tabManager.activeTab.url)) {
      tabManager.updateTab(tabId: tabManager.activeTab.id, url: url);
    } else {
  ...
  void _goBack()      => _webViewKey.currentState?.goBack();
          ...
          return Scaffold(
            ...
            body: SafeArea(
              child: Column(
                ...
                DulceNavBar(
                  canGoBack: _webViewController.pageInfo.canGoBack,
